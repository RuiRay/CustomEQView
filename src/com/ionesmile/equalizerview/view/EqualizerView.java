package com.ionesmile.equalizerview.view;
...
import com.ionesmile.equalizerview.R;
import com.ionesmile.equalizerview.utils.PixelUtil;
...
public class EqualizerView extends View {
	...
	private int isTouchedBand(int x, int y) {
		if (mEnableTouch && y > (mTopPadding-mValidTouchRadius) && y < (mBandLineYEndPostion+mValidTouchRadius)) {
			for (int i = 0; i < BAND_COUNT; i++) {
